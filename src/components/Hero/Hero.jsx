...
const dynamicPhrases = [
  'أنتِ السبب الذي يجعل كل شيء يستحق',
  'معك، الحياة لها معنى آخر',
  'قصتنا أجمل من أي خيال',
  'أنتِ البداية... وأنتِ المنتهى',
  'كل لحظة معك هدية من السماء',
  'أنتِ الـ Home الذي يبحث عنه قلبي',
]
